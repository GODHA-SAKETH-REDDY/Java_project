...
const Profile = () => {
  ...
  const stats = [
    { icon: 'bi-bookmark-check', label: 'Bookmarked Events', value: 0 },
    { icon: 'bi-calendar', label: 'Personal Events', value: 0 },
    { icon: 'bi-clock-history', label: 'Member Since', value: profile.joined ? new Date(profile.joined).toLocaleDateString() : 'N/A' },
  ];
